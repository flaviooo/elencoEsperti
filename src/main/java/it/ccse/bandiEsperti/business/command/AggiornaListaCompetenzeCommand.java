 ...
 */
public class AggiornaListaCompetenzeCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public AggiornaListaCompetenzeCommand(List<?> list) {
		super(null);
		super.setList(list);
	}
	...
	public boolean execute() {
		...
		if(getList() != null){
			try {
				es.aggiornaCompetenzeEsperto(getList());
				res = true;
			} catch (Exception e) {
