 ...
 */
public class AggiornaListaPubblicazioniCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public AggiornaListaPubblicazioniCommand(List<?> list) {
		super(null);
		super.setList(list);
	}
	...
	public boolean execute() {
		...
		if(getList() != null){
			try {
				es.aggiornaPubblicazioniEsperto(getList());
				res = true;
			} catch (Exception e) {
