 ...
 */
public class RicercaPubblicazioniCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public RicercaPubblicazioniCommand(Integer idEsperto) {
		super(null);
	...
	public boolean execute() {
		...
		if(getE() != null){
			try {
				set = es.ricercaTuttePubblicazioni(getE().getId());
				res = true;
			} catch (Exception e) {
