 ...
 */
public class AggiornaListaPrecedentiIncarichiCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public AggiornaListaPrecedentiIncarichiCommand(List<?> list) {
		super(null);
		super.setList(list);
	}
	...
	public boolean execute() {
		...
		if(getList() != null){
			try {
				es.aggiornaPrecedentiIncarichiEsperto(getList());
				res = true;
			} catch (Exception e) {
