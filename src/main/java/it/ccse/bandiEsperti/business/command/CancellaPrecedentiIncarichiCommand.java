 ...
 */
public class CancellaPrecedentiIncarichiCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public CancellaPrecedentiIncarichiCommand(Integer id) {
		super(null);
		super.setId(id);
	}
	...
	public boolean execute() {
		...
		// controlli per rendere "safe" il metodo
			...
			try {
				es.cancellaPrecedentiIncarichi(getId());
				res = true;
			} catch (Exception e) {
