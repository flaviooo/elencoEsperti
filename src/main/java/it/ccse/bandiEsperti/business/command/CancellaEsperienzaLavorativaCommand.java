 ...
 */
public class CancellaEsperienzaLavorativaCommand extends AbstractCommand {

	/**
	 * Deve esistere un esperto all'atto del salvataggio delle relative pubblicazioni
	 * */
	public CancellaEsperienzaLavorativaCommand(Integer id) {
		super(null);
		super.setId(id);
	}
	...
	public boolean execute() {
		...
		// controlli per rendere "safe" il metodo
			...
			try {
				es.cancellaEsperienzaLavorativa(getId());
				res = true;
			} catch (Exception e) {
